                ...
                <div class="col-md-6 offset-md-3">
                    <div class="signup-form">
                        <form action="" method="POST" class="mt-5 border p-4 bg-light shadow">
                            <h4 class="mb-8 text-secondary">Add new Member</h4>
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="Adresse_Membre" class="form-control" placeholder="Enter Your Adresse" required>
                                </div>

                                <div class="mb-3 col-md-6">
                                    <label>Cin<span class="text-danger">*</span></label>
                                    <input type="text" name="Cin_Membre" class="form-control" placeholder="Enter Cin" required>
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="Ville_Membre" class="form-control" placeholder="Enter Your Ville" required>
                                </div> 
                                ...
                                <div> <?php $Membre->Create_Membre(); ?></div>
                                <div class="mb-3 col-md-12">
                                    ...
                                    <span class="float-end shadow"> &nbsp;</span>
                                </div>
                            </div>
                        </form>
                    </div>
